    ...
    function wpBugTracktorReportAnIssueStep1() {
            ...
            <!--
                ...
                function wpBugTracktorSubmitIssue() {
                    ...
                    jQuery.post("'.admin_url( 'admin-ajax.php' ).'?action=wpbt_save_issue", {
                        ...
                        wpBugTracktorReportCaptcha: jQuery("#wpBugTracktorReportCaptcha").val()
                    } , function(data) {
                        if(data != 0) {
                        ';
        ...
        echo '<div id="wpBugTracktorReport" style="display:none;">
                <form id="wpBugTracktorReportForm" method="post" action="">
                    ...
                    <label class="wpBugTracktorFormLabel">'.__('Your Email Address', 'wpbugtracktor').': <input type="text" name="wpBugTracktorReportFormEmail" id="wpBugTracktorReportFormEmail" class="wpBugTracktorFormFullWidthText" /> </label>';
